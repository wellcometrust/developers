...
class Server {
    ...
    async renderToHTMLWithComponents(req, res, pathname, query = {}, result, opts) {
        ...
        return render_1.renderToHTML(req, res, pathname, query, Object.assign({}, result, opts, { PageConfig: result.PageConfig }));
    }
    ...
    async renderErrorToHTML(err, req, res, _pathname, query = {}) {
        ...
        return this.renderToHTMLWithComponents(req, res, '/_error', query, result, Object.assign({}, this.renderOpts, { err }));
    }
