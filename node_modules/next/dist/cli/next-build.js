...
if((0,_fs.existsSync)((0,_path.join)(dir,'..','pages'))){(0,_utils.printAndExit)('> No `pages` directory found. Did you mean to run `next` in the parent (`../`) directory?');}(0,_utils.printAndExit)("> Couldn't find a `pages` directory. Please create one under the project root");}(0,_build.default)(dir).catch(err=>{// tslint:disable-next-line
